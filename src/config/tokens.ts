...
export const XLAYER_TESTNET_TOKENS: Record<string, Token> = {
  ...
  USDC: {
    ...
    provenance: "Xecute-supported Testnet USDC test asset / Router supported",
    isTestAsset: true,
    verified: true,
    source: "testnet_asset",
    description: "Xecute-supported Testnet USDC test asset",
  },
  USDG: {
    ...
    chainId: 1952,
    variant: "test-simulated",
    provenance: "Xecute-supported Testnet USDG test asset / Router supported",
    isTestAsset: true,
    verified: true,
    source: "testnet_asset",
    description: "Xecute-supported Testnet USDG test asset",
  },
}
