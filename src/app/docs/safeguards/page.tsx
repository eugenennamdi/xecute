      ...
      <div className="space-y-4">
        {[
          ...
          },
          {
            ...
            desc: "The connected wallet chain is checked against X Layer Testnet chain ID 1952. State-changing actions are permitted only on X Layer Testnet, while Mainnet (196) is strictly locked to read-only advisory operations.",
          ...
          },
          {
            ...
            desc: "Xecute queries the token contract directly via eth_call before transaction preparation. If the wallet balance is insufficient, execution is blocked with clear feedback.",
          ...
          },
          {
            ...
            rationale: "Detects likely onchain execution reverts before signing.",
          },
          {
            num: "7",
